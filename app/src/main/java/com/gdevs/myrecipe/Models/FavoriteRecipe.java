...
public class FavoriteRecipe implements Serializable {
    ...
    String recipePerson;
    @ColumnInfo(name = "recipe_views")
    String recipeViews;
    @ColumnInfo(name = "recipe_featured")
    ...
    public FavoriteRecipe(int id, String recipeName, String recipeImage, String recipeVideo, String recipeType, String recipeDetails, String recipeIngredients, String recipeDescription, String recipeTime, String recipePerson, String recipeViews, String recipeFeatured, String recipeCategoryName) {
        this.id = id;
        ...
        this.recipeFeatured = recipeFeatured;
    ...
    public String getRecipeFeatured() {
        return recipeFeatured;
    }

    public void setRecipeFeatured(String recipeFeatured) {
        this.recipeFeatured = recipeFeatured;
    }
}
