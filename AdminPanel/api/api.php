<?php 
    ...
    } else if (isset($_GET['action']) && $_GET['action'] == "set_count") {

        $id = $_GET['id'];
        setCount($id);

    } else if (isset($_GET['action']) && $_GET['action'] == "get_recipe_details") {
        $id = $_GET['id'];
        getRecipeDetails($id);

    } else if (isset($_GET['action']) && $_GET['action'] == "get_all_data") {
